...
uint8_t maxCountFeatureReport_2[2] = {REPORTID_MAX_COUNT, MAX_CONTACT_COUNT};
uint8_t certificationFeatureReport_2[257] = {
...
//        		maxCountFeatureReport.max_contact_count = MAX_CONTACT_COUNT;
        		USBD_CtlSendData(pdev, (uint8_t*)&maxCountFeatureReport_2, sizeof (maxCountFeatureReport_2));
					...
					{
//        		CertificationFeatureReport certificationFeatureReport;
